...
1.  What is the *population* in this setting? Please be precise.
    ...
    The population could be thought of as the actual amount of PM in the air of the city.

2.  What are the *samples* in this setting? Please be precise.

    The samples are points of data within the population that were collected at certain areas. They are not the totality of PM in the air, since that is impossible to measure. But, hopefully, they represent enough of the PM at a variety of points that the population measurements can be extrapolated from the sample data.
...
1.  Are the differences in mean pollution as expected, given what we know about the sampling strategies?

This could be expected, based on the bias likely introduced into both samples given who was collecting them and for what purposes.
